<%-- 
    Document   : acceso
    Created on : 04/01/2023, 01:35:11
    Author     : jovi_
--%>
...
<html>
  ...
  <%
    ...
    Connection conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/proyecto_crud","root", "");
